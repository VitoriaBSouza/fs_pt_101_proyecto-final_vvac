    ...
    return (
        <div className="row m-0 ">
            <div className="col-12 d-flex justify-content-center">
                <div className="card bg-danger text-white h-75 w-75 g-0 rounded-0 border-0">
                    <img
                        src="src/front/assets/img/alimentosTop.jpg"
                        alt="Fondo"
                        className="img-fluid w-100 h-100 rounded-0 m-1 mx-auto"
                    />
                    <div className="card-img-overlay d-flex ms-auto align-items-center justify-content-center border-0">
